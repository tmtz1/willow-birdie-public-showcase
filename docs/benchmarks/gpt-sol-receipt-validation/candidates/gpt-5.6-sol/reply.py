...
_UNCONFIRMED_ERROR = "Buzz reply was not confirmed; do not retry this event blindly."
...
def _is_confirmed_receipt(stdout: object) -> bool:
    """Return whether stdout contains one valid, affirmative Buzz receipt."""
    ...
    return (
        ...
        and re.fullmatch(r"[0-9a-f]{64}", receipt["event_id"]) is not None
    )
    ...
    *,
    ...
    with _attempt_lock:
        ...
        try:
            ...
            raise RuntimeError(_UNCONFIRMED_ERROR) from None
    if getattr(result, "returncode", None) != 0:
        raise RuntimeError(_UNCONFIRMED_ERROR)
