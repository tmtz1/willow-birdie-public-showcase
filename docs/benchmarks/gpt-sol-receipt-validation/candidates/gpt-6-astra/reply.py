...
def _reject_json_constant(value: str) -> None:
    """Reject the non-JSON NaN and Infinity extensions accepted by json.loads."""
    ...
    with _attempt_lock:
        ...
        try:
            ...
            if result.returncode != 0 or not isinstance(result.stdout, str):
                raise ValueError("Unconfirmed Buzz send.")
            ...
            if (
                ...
                raise ValueError("Invalid Buzz receipt.")
        except Exception:
            # Transport and parser exceptions may contain private output.
            raise RuntimeError(
                "Buzz reply was not confirmed; do not retry this event blindly."
            ) from None
